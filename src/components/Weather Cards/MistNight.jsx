    ...
    <div className='flex flex-col relative overflow-hidden rounded-[0.6em_0.6em_0_0]'>
      <div className='flex justify-center items-center bg-slate-800  h-[25em]'>
        ...
        <div className='absolute flex'>
          <img
            className='blur-2xl scale-[3] relative top-[25em] z-50 right-[17em] animate-[cloudsss_2.7s_linear_alternate-reverse_infinite]'
            src={clouds}
            alt='clouds'
          />
          <img
            className='blur-2xl scale-[3] relative top-[25em] z-50 right-[-6em] animate-[cloudsss_4s_linear_alternate-reverse_infinite]'
            src={clouds}
            alt='clouds'
          />
        </div>
